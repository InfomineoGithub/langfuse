...
Common labels
*/}}
{{- define "infomineo-chatbot.labels" -}}
helm.sh/chart: {{ include "infomineo-chatbot.chart" . }}
{{ include "infomineo-chatbot.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "infomineo-chatbot.chart" -}}
...
Selector labels
*/}}
{{- define "infomineo-chatbot.selectorLabels" -}}
app.kubernetes.io/name: {{ include "infomineo-chatbot.name" . }}
